...
export const AlignRight = ({ size = 'xs', color = '#000' }: IconProps) => (
    // @todo adjust viewbox to match the aspect ratio width * 1.2
    <svg className={getIconSize(size)} viewBox="0 0 24 20" fill="none" xmlns="http://www.w3.org/2000/svg">
