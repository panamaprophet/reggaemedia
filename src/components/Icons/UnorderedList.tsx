...
export const UnorderedList = ({ size = 'xs', color = '#000' }: IconProps) => (
    // adjust height size * 0.7
    <svg className={getIconSize(size)} viewBox="0 0 22 16" fill="none" xmlns="http://www.w3.org/2000/svg">
